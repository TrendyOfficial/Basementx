...
const providedEn = {
  ...
  "footer": {
    "legal": {
      ...
      "disclaimerText": "Please note: P-Stream does not host any files itself; instead, it only displays content from third-party providers. Legal issues should be taken up with them."
    },
    "links": {
      "fluxer": "Fluxer",
      "legal": "Legal / DMCA",
  ...
  "onboarding": {
    "defaultConfirm": {
      ...
      "tip": "It's recommended to set up the extension and/or FED API!",
      "title": "Are you sure?"
    },
    "extension": {
      "back": "Go back",
    ...
    "start": {
      ...
      "moreInfo": {
        "button": "Which setup should I choose?",
        ...
        "explainer": {
          ...
          "outro": "If you have more questions on how this works, feel free to ask on the <0>P-Stream Fluxer</0> server!"
        },
        "recommended": {
          ...
          "desktop": {
            "title": "Desktop:",
            "description": "Extension (or app) + Febbox token"
          },
          "iOS": {
            "title": "iOS:",
      ...
      "options": {
        ...
        "desktopapp": {
          ...
          "description": "Install desktop app and gain access to additional sources! Simple and easy to use!",
          "quality": "Best quality + Even more sources",
          "title": "P-Stream Desktop app"
        },
        "proxy": {
          "action": "Setup proxy",
  ...
  "settings": {
    ...
    "appearance": {
      ...
      "customTheme": {
        ...
        "primaryColorLabel": "Primary accent color",
        "secondaryColorLabel": "Secondary text color",
        "tertiaryColorLabel": "Background color"
      },
      "title": "Appearance",
      "options": {
        ...
        "themeOptions": {
          ...
          "themeLimitReached": "Theme limit reached (30 max)",
          "resetToDefault": "Reset to Default"
        }
      },
      "sections": {
  ...
  "fedapi": {
    "onboarding": {
      ...
      "note": "Note: FED API was a scraper originally created by OG P-Stream Developer Nemo. XP Technologies recreated the scraper to match its functionalities \u2014 it does not take any credit for the name or the original scraper."
    },
    "setup": {
      ...
      "traffic": "{{used}} / {{limit}} High-speed Traffic",
      "trafficExplanation": "Febbox gives you high-speed traffic per month, the streams might buffer more after you've used up your quota. Depends on your internet speed and the quality of the stream.",
